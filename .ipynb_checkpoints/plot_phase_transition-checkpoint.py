...
ax.plot(1.0/κ_list, np.zeros(len(κ_list)), label='Mean Field',linewidth=1.132,c='#cb3f10', linestyle=(0,(4,2.5)))
ax.plot(1.0/κ_list, np.abs(np.array(list(Y.values()))), label='Second Order',linewidth=1.132,c='#1b485e', linestyle='-')
